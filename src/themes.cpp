...
void OS::use_native_fonts() {
	...
	const char *bold_italic_monospace_fonts[3] = {
	...
	const char *bold_italic_monospace_fonts[4] = {
		"Ubuntu Mono bold italic", "Noto Sans Mono bold italic", "Droid Sans Mono bold italic", "DejaVu Sans Mono bold italic"
	};
	use_any_font(FL_COURIER_BOLD_ITALIC, bold_italic_monospace_fonts, _countof(bold_italic_monospace_fonts));
#endif
...
void irushTan() {
        Fl::set_color(Fl_Color(0), 0, 0, 0); //		# black: color of most label text
        Fl::set_color(Fl_Color(1), 255, 0, 0); //		# red: red tty errors
        Fl::set_color(Fl_Color(2), 0, 255, 0); //		# grn: jobs 'Continue' button border color
        Fl::set_color(Fl_Color(3), 255, 255, 0); //		# yel
        Fl::set_color(Fl_Color(4), 0, 0, 255); //		# blu (label color for "Reports", "Current Job", "Run/Busy" state..)
        Fl::set_color(Fl_Color(5), 255, 0, 255); //		# mag: LOGFILE: jobdonecommand.log, jobdumpcommand.log
        Fl::set_color(Fl_Color(6), 0, 255, 255); //
        Fl::set_color(Fl_Color(7), 255, 255, 255); //		# bg color of some input fields (Try, Add..)
        Fl::set_color(Fl_Color(8), 85, 85, 85); //
        Fl::set_color(Fl_Color(9), 198, 113, 113); //		# Dump button red
        Fl::set_color(Fl_Color(10), 113, 198, 113); //
        Fl::set_color(Fl_Color(11), 142, 142, 56); //
        Fl::set_color(Fl_Color(12), 113, 113, 198); //
        Fl::set_color(Fl_Color(13), 200, 150, 200); //		# desaturated magenta: color for the 'enabled' search box
        Fl::set_color(Fl_Color(14), 56, 142, 142); //
        Fl::set_color(Fl_Color(15), 0, 0, 128); //		# checks in checkboxes (Edit|Preferences..)
        Fl::set_color(Fl_Color(32), 0,   0,   0); //
        Fl::set_color(Fl_Color(33), 114, 100, 46); //
        Fl::set_color(Fl_Color(34), 120, 107, 56); //
        Fl::set_color(Fl_Color(35), 127, 114, 65); //
        Fl::set_color(Fl_Color(36), 133, 121, 75); //
        Fl::set_color(Fl_Color(37), 140, 128, 84); //
        Fl::set_color(Fl_Color(38), 146, 135, 94); //
        Fl::set_color(Fl_Color(39), 152, 142, 103); //
        Fl::set_color(Fl_Color(40), 159, 149, 113); //
        Fl::set_color(Fl_Color(41), 165, 156, 122); //
        Fl::set_color(Fl_Color(42), 172, 163, 132); //
        Fl::set_color(Fl_Color(43), 178, 170, 141); //
        Fl::set_color(Fl_Color(44), 185, 178, 151); //
        Fl::set_color(Fl_Color(45), 191, 185, 160); //
        Fl::set_color(Fl_Color(46), 197, 192, 170); //
        Fl::set_color(Fl_Color(47), 204, 199, 179); //
        Fl::set_color(Fl_Color(48), 210, 206, 189); //
        Fl::set_color(Fl_Color(49), 217, 213, 198); //
        Fl::set_color(Fl_Color(50), 223, 220, 208); //
        Fl::set_color(Fl_Color(51), 229, 227, 217); //
        Fl::set_color(Fl_Color(52), 236, 234, 227); //
        Fl::set_color(Fl_Color(53), 242, 241, 236); //
        Fl::set_color(Fl_Color(54), 249, 248, 246); //
        Fl::set_color(Fl_Color(55), 255, 255, 255); //
    //# Default color cube
/*
    Fl::set_color(Fl_Color(56  0   0   0
    Fl::set_color(Fl_Color(57  0   36  0
    Fl::set_color(Fl_Color(58  0   73  0
    Fl::set_color(Fl_Color(59  0   109 0		# "Done" green
    Fl::set_color(Fl_Color(60  0   146 0
    Fl::set_color(Fl_Color(61  0   182 0
    Fl::set_color(Fl_Color(62  0   219 0
    Fl::set_color(Fl_Color(63  0   255 0
    Fl::set_color(Fl_Color(64  64  0   0
    Fl::set_color(Fl_Color(65  64  36  0
    Fl::set_color(Fl_Color(66  64  73  0
    Fl::set_color(Fl_Color(67  64  109 0
    Fl::set_color(Fl_Color(68  64  146 0
    Fl::set_color(Fl_Color(69  64  182 0
    Fl::set_color(Fl_Color(70  64  219 0
    Fl::set_color(Fl_Color(71  64  255 0
    Fl::set_color(Fl_Color(72  128 0   0
    Fl::set_color(Fl_Color(73  128 36  0
    Fl::set_color(Fl_Color(74  128 73  0
    Fl::set_color(Fl_Color(75  128 109 0
    Fl::set_color(Fl_Color(76  128 146 0
    Fl::set_color(Fl_Color(77  128 182 0
    Fl::set_color(Fl_Color(78  128 219 0
    Fl::set_color(Fl_Color(79  128 255 0
    Fl::set_color(Fl_Color(80  191 0   0
    Fl::set_color(Fl_Color(81  191 36  0
    Fl::set_color(Fl_Color(82  191 73  0
    Fl::set_color(Fl_Color(83  191 109 0
    Fl::set_color(Fl_Color(84  191 146 0
    Fl::set_color(Fl_Color(85  191 182 0
    Fl::set_color(Fl_Color(86  191 219 0
    Fl::set_color(Fl_Color(87  191 255 0
    Fl::set_color(Fl_Color(88  255 0   0
    Fl::set_color(Fl_Color(89  255 36  0
    Fl::set_color(Fl_Color(90  255 73  0		# Die/Pause orange
    Fl::set_color(Fl_Color(91  255 109 0
    Fl::set_color(Fl_Color(92  255 146 0
    Fl::set_color(Fl_Color(93  255 182 0
    Fl::set_color(Fl_Color(94  255 219 0		# report button 'running a command'
    Fl::set_color(Fl_Color(95  255 255 0		# text selection color
    Fl::set_color(Fl_Color(96  0   0   64
    Fl::set_color(Fl_Color(97  0   36  64
    Fl::set_color(Fl_Color(98  0   73  64
    Fl::set_color(Fl_Color(99  0   109 64
    Fl::set_color(Fl_Color(100 0   146 64
    Fl::set_color(Fl_Color(101 0   182 64
    Fl::set_color(Fl_Color(102 0   219 64
    Fl::set_color(Fl_Color(103 0   255 64
    Fl::set_color(Fl_Color(104 64  0   64
    Fl::set_color(Fl_Color(105 64  36  64
    Fl::set_color(Fl_Color(106 64  73  64
    Fl::set_color(Fl_Color(107 64  109 64
    Fl::set_color(Fl_Color(108 64  146 64
    Fl::set_color(Fl_Color(109 64  182 64
    Fl::set_color(Fl_Color(110 64  219 64
    Fl::set_color(Fl_Color(111 64  255 64
    Fl::set_color(Fl_Color(112 128 0   64
    Fl::set_color(Fl_Color(113 128 36  64
    Fl::set_color(Fl_Color(114 128 73  64
    Fl::set_color(Fl_Color(115 128 109 64
    Fl::set_color(Fl_Color(116 128 146 64
    Fl::set_color(Fl_Color(117 128 182 64
    Fl::set_color(Fl_Color(118 128 219 64
    Fl::set_color(Fl_Color(119 128 255 64
    Fl::set_color(Fl_Color(120 191 0   64
    Fl::set_color(Fl_Color(121 191 36  64
    Fl::set_color(Fl_Color(122 191 73  64
    Fl::set_color(Fl_Color(123 191 109 64
    Fl::set_color(Fl_Color(124 191 146 64
    Fl::set_color(Fl_Color(125 191 182 64
    Fl::set_color(Fl_Color(126 191 219 64
    Fl::set_color(Fl_Color(127 191 255 64
    Fl::set_color(Fl_Color(128 255 0   64
    Fl::set_color(Fl_Color(129 255 36  64
    Fl::set_color(Fl_Color(130 255 73  64
    Fl::set_color(Fl_Color(131 255 109 64
    Fl::set_color(Fl_Color(132 255 146 64
    Fl::set_color(Fl_Color(133 255 182 64
    Fl::set_color(Fl_Color(134 255 219 64
    Fl::set_color(Fl_Color(135 255 255 64
    Fl::set_color(Fl_Color(136 0   0   128
    Fl::set_color(Fl_Color(137 0   36  128
    Fl::set_color(Fl_Color(138 0   73  128
    Fl::set_color(Fl_Color(139 0   109 128
    Fl::set_color(Fl_Color(140 0   146 128
    Fl::set_color(Fl_Color(141 0   182 128
    Fl::set_color(Fl_Color(142 0   219 128
    Fl::set_color(Fl_Color(143 0   255 128
    Fl::set_color(Fl_Color(144 64  0   128
    Fl::set_color(Fl_Color(145 64  36  128
    Fl::set_color(Fl_Color(146 64  73  128
    Fl::set_color(Fl_Color(147 64  109 128
    Fl::set_color(Fl_Color(148 64  146 128
    Fl::set_color(Fl_Color(149 64  182 128
    Fl::set_color(Fl_Color(150 64  219 128
    Fl::set_color(Fl_Color(151 64  255 128
    Fl::set_color(Fl_Color(152 128 0   128
    Fl::set_color(Fl_Color(153 128 36  128
    Fl::set_color(Fl_Color(154 128 73  128
    Fl::set_color(Fl_Color(155 128 109 128
    Fl::set_color(Fl_Color(156 128 146 128
    Fl::set_color(Fl_Color(157 128 182 128
    Fl::set_color(Fl_Color(158 128 219 128
    Fl::set_color(Fl_Color(159 128 255 128
    Fl::set_color(Fl_Color(160 191 0   128
    Fl::set_color(Fl_Color(161 191 36  128
    Fl::set_color(Fl_Color(162 191 73  128
    Fl::set_color(Fl_Color(163 191 109 128
    Fl::set_color(Fl_Color(164 191 146 128
    Fl::set_color(Fl_Color(165 191 182 128
    Fl::set_color(Fl_Color(166 191 219 128
    Fl::set_color(Fl_Color(167 191 255 128
    Fl::set_color(Fl_Color(168 255 0   128
    Fl::set_color(Fl_Color(169 255 36  128
    Fl::set_color(Fl_Color(170 255 73  128
    Fl::set_color(Fl_Color(171 255 109 128
    Fl::set_color(Fl_Color(172 255 146 128
    Fl::set_color(Fl_Color(173 255 182 128
    Fl::set_color(Fl_Color(174 255 219 128
    Fl::set_color(Fl_Color(175 255 255 128
    Fl::set_color(Fl_Color(176 0   0   191
    Fl::set_color(Fl_Color(177 0   36  191
    Fl::set_color(Fl_Color(178 0   73  191
    Fl::set_color(Fl_Color(179 0   109 191
    Fl::set_color(Fl_Color(180 0   146 191
    Fl::set_color(Fl_Color(181 0   182 191
    Fl::set_color(Fl_Color(182 0   219 191
    Fl::set_color(Fl_Color(183 0   255 191
    Fl::set_color(Fl_Color(184 64  0   191
    Fl::set_color(Fl_Color(185 64  36  191
    Fl::set_color(Fl_Color(186 64  73  191
    Fl::set_color(Fl_Color(187 64  109 191
    Fl::set_color(Fl_Color(188 64  146 191
    Fl::set_color(Fl_Color(189 64  182 191
    Fl::set_color(Fl_Color(190 64  219 191
    Fl::set_color(Fl_Color(191 64  255 191
    Fl::set_color(Fl_Color(192 128 0   191
    Fl::set_color(Fl_Color(193 128 36  191
    Fl::set_color(Fl_Color(194 128 73  191
    Fl::set_color(Fl_Color(195 128 109 191
    Fl::set_color(Fl_Color(196 128 146 191
    Fl::set_color(Fl_Color(197 128 182 191
    Fl::set_color(Fl_Color(198 128 219 191
    Fl::set_color(Fl_Color(199 128 255 191
    Fl::set_color(Fl_Color(200 191 0   191
    Fl::set_color(Fl_Color(201 191 36  191
    Fl::set_color(Fl_Color(202 191 73  191
    Fl::set_color(Fl_Color(203 191 109 191
    Fl::set_color(Fl_Color(204 191 146 191
    Fl::set_color(Fl_Color(205 191 182 191
    Fl::set_color(Fl_Color(206 191 219 191
    Fl::set_color(Fl_Color(207 191 255 191
    Fl::set_color(Fl_Color(208 255 0   191
    Fl::set_color(Fl_Color(209 255 36  191
    Fl::set_color(Fl_Color(210 255 73  191
    Fl::set_color(Fl_Color(211 255 109 191
    Fl::set_color(Fl_Color(212 255 146 191
    Fl::set_color(Fl_Color(213 255 182 191
    Fl::set_color(Fl_Color(214 255 219 191
    Fl::set_color(Fl_Color(215 255 255 191
    Fl::set_color(Fl_Color(216 0   0   255
    Fl::set_color(Fl_Color(217 0   36  255
    Fl::set_color(Fl_Color(218 0   73  255
    Fl::set_color(Fl_Color(219 0   109 255
    Fl::set_color(Fl_Color(220 0   146 255
    Fl::set_color(Fl_Color(221 0   182 255
    Fl::set_color(Fl_Color(222 0   219 255
    Fl::set_color(Fl_Color(223 0   255 255
    Fl::set_color(Fl_Color(224 64  0   255
    Fl::set_color(Fl_Color(225 64  36  255
    Fl::set_color(Fl_Color(226 64  73  255
    Fl::set_color(Fl_Color(227 64  109 255
    Fl::set_color(Fl_Color(228 64  146 255
    Fl::set_color(Fl_Color(229 64  182 255
    Fl::set_color(Fl_Color(230 64  219 255
    Fl::set_color(Fl_Color(231 64  255 255
    Fl::set_color(Fl_Color(232 128 0   255
    Fl::set_color(Fl_Color(233 128 36  255
    Fl::set_color(Fl_Color(234 128 73  255
    Fl::set_color(Fl_Color(235 128 109 255
    Fl::set_color(Fl_Color(236 128 146 255
    Fl::set_color(Fl_Color(237 128 182 255
    Fl::set_color(Fl_Color(238 128 219 255
    Fl::set_color(Fl_Color(239 128 255 255
    Fl::set_color(Fl_Color(240 191 0   255
    Fl::set_color(Fl_Color(241 191 36  255
    Fl::set_color(Fl_Color(242 191 73  255
    Fl::set_color(Fl_Color(243 191 109 255
    Fl::set_color(Fl_Color(244 191 146 255
    Fl::set_color(Fl_Color(245 191 182 255
    Fl::set_color(Fl_Color(246 191 219 255
    Fl::set_color(Fl_Color(247 191 255 255
    Fl::set_color(Fl_Color(248 255 0   255
    Fl::set_color(Fl_Color(249 255 36  255
    Fl::set_color(Fl_Color(250 255 73  255
    Fl::set_color(Fl_Color(251 255 109 255
    Fl::set_color(Fl_Color(252 255 146 255
    Fl::set_color(Fl_Color(253 255 182 255
    Fl::set_color(Fl_Color(254 255 219 255
    Fl::set_color(Fl_Color(255 255 255 255
    # RE-PROGRAMMED COLORS
    #     We have to force these off the normal ramps
    #     for the interface to look right..
    #
    Fl::set_color(Fl_Color(254 220 240 240        # bgcolor of 'current jobid' lines in tty browser
    */
    Fl::reload_scheme(); // if plastic/gtk+/etc, update with new colors
}
